...
Offset X/Y is how much the character is offset from the character. Positive X is right, positive Y is down.
...
(If a note isn't selected the game will crash so make sure it's selected)
...
The toggle also only affects the duet partners of whoever is singing the note.
